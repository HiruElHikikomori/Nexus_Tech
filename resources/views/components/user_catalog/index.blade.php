...
<div class="container bg-accent1 m-auto rounded text-white p-5">
    <h3>
        Catálogo de piezas de usuarios
        @if(request('query')) para "{{ request('query') }}" @endif
    </h3>
            ...
            <div class="row align-items-end">
                ...
                <div class="col col-md-4 col-lg-5 text-center">
                    <label class="form-label">
                        ...
                        <span>$</span><span id="minPriceDisplay">0</span>
                        – $<span id="maxPriceDisplay">Máx</span>
                    </label>
...
<div class="container bg-accent1 rounded text-white p-5 my-5">
    <h1 class="text-white py-3">Piezas publicadas por usuarios</h1>
                ...
                <div class="modal-dialog modal-lg">
                    <div class="modal-content p-3 bg-accent1 border-0">
                        <div class="modal-header border border-accent1">
                            <h3 class="modal-title" id="userProductLabel{{ $item->user_product_id }}">
